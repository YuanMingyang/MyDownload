 ...
 */
- (void)download:(NSString *)urlString progress:(void(^)(TaskProgressInfo *progressInfo))progressInfo complete:(void(^)(NSString *filePath,NSError *error))complete enableBackgroundMode:(BOOL)backgroundMode;
